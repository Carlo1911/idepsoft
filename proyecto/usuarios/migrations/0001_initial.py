# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-07 23:38
from __future__ import unicode_literals

from django.db import migrations, models
import proyecto.usuarios.managers
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('admin', 'Administrador'), ('experto', 'Experto'), ('regular', 'Regular')], default='regular', max_length=20, verbose_name='Tipo de usuario')),
            ...
            managers=[
                ('objects', proyecto.usuarios.managers.UserManager()),
            ],
        ),
    ]
